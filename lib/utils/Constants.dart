...
//region App name
const mAppName = 'UR-Lift Driver';
//endregion

//region DomainUrl
const DOMAIN_URL = 'https://urlift.world/taxi'; // Don't add slash at the end of the url


//endregion
const GOOGLE_MAP_API_KEY = 'AIzaSyBxvGwxaRoGuRDro2D4eJDcSfVaf8Sz8jY';
//endregion


//region MQTT port and unique name
//region MQTT port and unique name
final client = MqttServerClient.withPort("broker.hivemq.com", "", 8000);
const MQTT_UNIQUE_TOPIC_NAME = 'device/prachi/data'; // Don't add underscore at the end of the url
//endregion


//region OneSignal Keys
//You have to generate 2 onesignal account one for rider and one for driver
const mOneSignalAppIdDriver = 'ec876c57-bf08-4ff8-a0aa-fee5541b289c';
const mOneSignalRestKeyDriver = 'YTIyM2U0NGEtMzc5NC00ZTYyLTgwODUtMjljMzcxNjNkZmQx';

const mOneSignalAppIdRider = '3ce12c6d-c541-4a69-8974-6dc17bc446d6';
const mOneSignalRestKeyRider = 'MjU4MTVlODctMDFmNy00Y2QyLWIzNzQtMjA5MWQzNDJjNTI5';
...
const PDF_NAME = 'UR-Lift Driver Taxi  Private Limited';
