...
import 'package:ur_lift_driver_app/screens/pre_booking.dart';
import 'package:ur_lift_driver_app/screens/share_ride.dart';
...
import '../screens/rantal_booking.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            DrawerWidget(
                title: "Rantal Booking",
                iconData: ic_my_rides,
                icon: Ionicons.car_outline,
                onTap: () {
                  Navigator.pop(context);
                  launchScreen(context, RentalBooking(), pageRouteAnimation: PageRouteAnimation.Slide);
                }),
            DrawerWidget(
                title: "Ride Share Booking",
                iconData: ic_my_rides,
                icon: Ionicons.car_outline,
                onTap: () {
                  Navigator.pop(context);
                  launchScreen(context, RideShareBooking(), pageRouteAnimation: PageRouteAnimation.Slide);
                }),
            DrawerWidget(
            ...
            DrawerWidget(
                ...
                iconData: ic_setting,
                onTap: () {
                  launchScreen(context, PreBookingScreen(), pageRouteAnimation: PageRouteAnimation.Slide);
                }),
            DrawerWidget(
                title: language.shareApp,
                iconData: ic_share,
                onTap: () async {
                  final urlPreview = 'https://play.google.com/store/games';
                  await Share.share('\n\n$urlPreview');
                }),
            DrawerWidget(
