...
import 'package:ur_lift_driver_app/screens/ChatScreen.dart';
import 'package:ur_lift_driver_app/screens/DetailScreen.dart';
import 'package:ur_lift_driver_app/screens/ReviewScreen.dart';
import 'package:ur_lift_driver_app/utils/Extensions/StringExtensions.dart';
import 'package:ur_lift_driver_app/utils/Extensions/context_extensions.dart';
        ...
        Column(
          children: [
            ...
            inkWellWidget(
              ...
              child: Image.asset("images/sosicon.jfif", fit: BoxFit.contain, height: 35, width: 35),
            ),
          ],
        ),
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        icon: Image.asset(ic_triangle, height: 50 ,width: 50,),
        title: Text('USE IN CASE OF EMERGENCY', style: boldTextStyle(color: Colors.red),),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            // Text('Do you want to send an emergency message?'),
            SizedBox(height: 2.0),
            Column(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text("navin"),
                        Text("9867345634",style: TextStyle(color: Colors.green),)
                      ],
                    ),
                    ElevatedButton.icon(
                      onPressed: () {
...
void sendEmergencySMS() {
  ...
  String emergencyContactNumber = '123456789';

  // Replace with the actual message you want to send
  String emergencyMessage = 'Emergency! Need help!';

  // Use the SMS sending code from the previous example
  // ...

  print('Emergency SMS sent to $emergencyContactNumber: $emergencyMessage');
}
...
void makeEmergencyCall() {
  ...
  // Use the code to initiate a call
  // ...

  print('Making emergency call to $emergencyContactNumber');
}
